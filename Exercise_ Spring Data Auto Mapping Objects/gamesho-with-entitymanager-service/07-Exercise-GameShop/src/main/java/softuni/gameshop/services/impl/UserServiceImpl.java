...
public class UserServiceImpl implements UserService {
    ...
    private final EntityManagerUserServiceImpl entityManager;
    ...
    public UserServiceImpl(ModelMapper mapper,
                           ...
                           StringBuilder sb,
                           GamesRepository gamesRepository, EntityManagerUserServiceImpl entityManager) {
        this.mapper = mapper;
    ...
    public String buyItem() {
        ...
        this.entityManager.detachUser(myUser);

        for (GamesDto gamesDto : games) {
            for (Game e : myUser.getGames()) {

                if (e.getTitle().equals(gamesDto.getTitle())) {
                    sb.append(String.format("User had game %s", gamesDto.getTitle()))
                            .append(System.lineSeparator());
                } else {
                    sb.append(gamesDto.toString())
                            .append(System.lineSeparator());
                    myUser.getGames().add(this.mapper.map(gamesDto, Game.class));
                }

            }

        }
        this.entityManager.mergeUser(myUser);
